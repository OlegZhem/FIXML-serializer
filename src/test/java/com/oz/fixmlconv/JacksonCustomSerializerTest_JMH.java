...
public class JacksonCustomSerializerTest_JMH {
    ...
    public static class BenchmarkState {
        ...
        public JacksonCustomSerializer jacksonCustomSerializer;
        public ToXmlGenerator toXmlGenerator;
        ...
        public void initializeEach() throws ConfigError, FieldNotFound, IOException {
            ...
            jacksonCustomSerializer = new JacksonCustomSerializer(
            DictionaryManager.dictionaryByMessage(message), fieldMapIteratorFactory);
            jsonWriter = new StringWriter();
            toXmlGenerator = new XmlFactory().createGenerator(jsonWriter);
            serializerProvider = xmlMapper.getSerializerProvider();
        }
...
*/
   ...
   @Benchmark
    public void benchmarkMethod(BenchmarkState state, Blackhole bh) throws Exception {
        state.jacksonCustomSerializer.serialize(state.message, state.toXmlGenerator, state.serializerProvider);
        state.toXmlGenerator.flush();
        bh.consume(state.jsonWriter.toString());
    }
